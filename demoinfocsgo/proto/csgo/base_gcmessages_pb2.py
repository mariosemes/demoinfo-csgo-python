...
_CMSGGCSTOREPURCHASEINITRESPONSE = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='url', full_name='CMsgGCStorePurchaseInitResponse.url', index=2,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='item_ids', full_name='CMsgGCStorePurchaseInitResponse.item_ids', index=3,
...
_CSOECONGAMEACCOUNTCLIENT = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='elevated_state', full_name='CSOEconGameAccountClient.elevated_state', index=3,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='elevated_timestamp', full_name='CSOEconGameAccountClient.elevated_timestamp', index=4,
...
_CMSGAPPLYSTICKER = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='sticker_wear', full_name='CMsgApplySticker.sticker_wear', index=4,
...
_CMSGMODIFYITEMATTRIBUTE = _descriptor.Descriptor(
  ...
  full_name='CMsgModifyItemAttribute',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='item_id', full_name='CMsgModifyItemAttribute.item_id', index=0,
      number=1, type=4, cpp_type=4, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='attr_defidx', full_name='CMsgModifyItemAttribute.attr_defidx', index=1,
      number=2, type=13, cpp_type=3, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='attr_value', full_name='CMsgModifyItemAttribute.attr_value', index=2,
      number=3, type=13, cpp_type=3, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_CMSGADJUSTITEMEQUIPPEDSTATEMULTI = _descriptor.Descriptor(
  ...
  full_name='CMsgAdjustItemEquippedStateMulti',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='t_equips', full_name='CMsgAdjustItemEquippedStateMulti.t_equips', index=0,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='ct_equips', full_name='CMsgAdjustItemEquippedStateMulti.ct_equips', index=1,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='noteam_equips', full_name='CMsgAdjustItemEquippedStateMulti.noteam_equips', index=2,
