...
_EGCITEMCUSTOMIZATIONNOTIFICATION = _descriptor.EnumDescriptor(
  ...
  full_name='EGCItemCustomizationNotification',
  filename=None,
  file=DESCRIPTOR,
  values=[
    _descriptor.EnumValueDescriptor(
...
_CMSGCASKETITEM = _descriptor.Descriptor(
  name='CMsgCasketItem',
  full_name='CMsgCasketItem',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='casket_item_id', full_name='CMsgCasketItem.casket_item_id', index=0,
      number=1, type=4, cpp_type=4, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='item_item_id', full_name='CMsgCasketItem.item_item_id', index=1,
      number=2, type=4, cpp_type=4, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
