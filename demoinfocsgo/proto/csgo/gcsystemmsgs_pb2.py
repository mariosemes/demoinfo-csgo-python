...
_ECOMMUNITYITEMATTRIBUTE = _descriptor.EnumDescriptor(
  ...
  full_name='ECommunityItemAttribute',
  filename=None,
  file=DESCRIPTOR,
  values=[
    _descriptor.EnumValueDescriptor(
...
_CQUEST_PUBLISHERADDCOMMUNITYITEMSTOPLAYER_REQUEST_ATTRIBUTE = _descriptor.Descriptor(
  name='Attribute',
  full_name='CQuest_PublisherAddCommunityItemsToPlayer_Request.Attribute',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='attribute', full_name='CQuest_PublisherAddCommunityItemsToPlayer_Request.Attribute.attribute', index=0,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='value', full_name='CQuest_PublisherAddCommunityItemsToPlayer_Request.Attribute.value', index=1,
...
_CQUEST_PUBLISHERADDCOMMUNITYITEMSTOPLAYER_REQUEST = _descriptor.Descriptor(
  ...
  full_name='CQuest_PublisherAddCommunityItemsToPlayer_Request',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='steamid', full_name='CQuest_PublisherAddCommunityItemsToPlayer_Request.steamid', index=0,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='appid', full_name='CQuest_PublisherAddCommunityItemsToPlayer_Request.appid', index=1,
      number=2, type=13, cpp_type=3, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='match_item_type', full_name='CQuest_PublisherAddCommunityItemsToPlayer_Request.match_item_type', index=2,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='match_item_class', full_name='CQuest_PublisherAddCommunityItemsToPlayer_Request.match_item_class', index=3,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='prefix_item_name', full_name='CQuest_PublisherAddCommunityItemsToPlayer_Request.prefix_item_name', index=4,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='attributes', full_name='CQuest_PublisherAddCommunityItemsToPlayer_Request.attributes', index=5,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='note', full_name='CQuest_PublisherAddCommunityItemsToPlayer_Request.note', index=6,
...
_CQUEST_PUBLISHERADDCOMMUNITYITEMSTOPLAYER_RESPONSE = _descriptor.Descriptor(
  ...
  full_name='CQuest_PublisherAddCommunityItemsToPlayer_Response',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='items_matched', full_name='CQuest_PublisherAddCommunityItemsToPlayer_Response.items_matched', index=0,
      number=1, type=13, cpp_type=3, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='items_granted', full_name='CQuest_PublisherAddCommunityItemsToPlayer_Response.items_granted', index=1,
      number=2, type=13, cpp_type=3, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
